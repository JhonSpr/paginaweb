                    ...
                    <div class="navigation">  
                        <div class="nav-options">       
                            <ul class="menu-navigation">
                                <li class="obj">
                                    <a href="index.html" class="bordes menu-responsive">INICIO</a>
                                </li>
                                <li class="obj">
            ...
            <div class="container-body margin-container">
                ...
                <div class="widget-emision">
                        ...
                        <div class="animes-emision">
                            <ul>
                                <li>
                                    <a href="#"  class="fa-play-circle">
                                        <span class="type-anime tv">Ova</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="animes/dororo.html" class="fa-play-circle">
                                        <span class="type-anime tv">Ova</span>
                                    </a>
                                </li>
                                <li>
                ...
                <main>
                    ...
                    <ul class="lastEpisodios">
                        <li>
                        <a href="animes/Kiseijuu: Sei no Kakuritsu.html" class="fa-play">
                            <span class="imagen-mask">
                                <img src="imagenes/1635.jpg" alt="miniatura">
                            </span>
                            <span class="nCapi2">Finalizado</span>
                            <strong class="title-cap-miniatura">Kiseijuu: Sei no Kakuritsu</strong>
                        </a>
                        </li>
                        <li>
                            <a href="" class="fa-play">
                                <span class="imagen-mask">
